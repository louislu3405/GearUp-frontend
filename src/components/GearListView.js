...
export default function GearListView({
  ...
  const dropdownTexts = ["Edit", "Duplicate", "Delete"];
            ...
            <table className={style["gear-list-table"]}>
              <thead className={style["gear-list-table-thead"]}>
                <tr>
                  ...
                  <th className={style["gear-list-table-th-shrink"]}>
                    Number of gears
                  </th>
                  <th className={style["gear-list-table-th-shrink"]}>
                    Unprepared
                ...
                {userGearLists.map(
                  (userGearList) =>
                    userGearList.image === null && ( // Temporarily prevent showing template gear lists
                      <tr
                        key={userGearList.id}
                        className={style["gear-list-table-tr"]}
                      >
                        <td
                          className={style["gear-list-table-td"]}
                          style={{ fontWeight: "700" }}
                        >
                          {userGearList.listName}
                        </td>
                        <td className={style["gear-list-table-td"]}>
                          {userGearList.activity}
                        </td>
                        <td className={style["gear-list-table-td"]}>
                          {userGearList.items.length}
                        </td>
                        <td className={style["gear-list-table-td"]}>
                          {calculateUnpreparedGearCount(userGearList.items)}
                        </td>
                        <td className={style["gear-list-table-td"]}>
                          {formatDatetime(userGearList.lastEdited)}
                        </td>
                        <td
                          className={style["gear-list-table-td"]}
                        ...
                        >
                          <svg
                            ...
                            fill="none"
                            onClick={() =>
                              setVisibleDropdownId(userGearList.id)
                            }
                          >
                            <path
                              d="M14.8975 3.43555C14.8975 4.67819 13.8901 5.68555 12.6475 5.68555C11.4048 5.68555 10.3975 4.67819 10.3975 3.43555C10.3975 2.19291 11.4048 1.18555 12.6475 1.18555C13.8901 1.18555 14.8975 2.19291 14.8975 3.43555Z"
                              fill="black"
                            />
                            <path
                              d="M14.8975 12.4355C14.8975 13.6782 13.8901 14.6855 12.6475 14.6855C11.4048 14.6855 10.3975 13.6782 10.3975 12.4355C10.3975 11.1929 11.4048 10.1855 12.6475 10.1855C13.8901 10.1855 14.8975 11.1929 14.8975 12.4355Z"
                              fill="black"
                            />
                            <path
                              d="M14.8975 21.4355C14.8975 22.6782 13.8901 23.6855 12.6475 23.6855C11.4048 23.6855 10.3975 22.6782 10.3975 21.4355C10.3975 20.1929 11.4048 19.1855 12.6475 19.1855C13.8901 19.1855 14.8975 20.1929 14.8975 21.4355Z"
                              fill="black"
                            />
                          </svg>
                          {
